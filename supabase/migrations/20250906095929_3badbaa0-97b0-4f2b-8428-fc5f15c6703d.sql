...
-- Create functions to encrypt/decrypt credentials safely
...
AS $$
  SELECT CASE 
    ...
    ELSE encode(encrypt_iv(credential::bytea, (user_uuid::text || 'spotify_key')::bytea, '\x00000000000000000000000000000000', 'aes'), 'base64')
  END;
$$;
...
AS $$
  SELECT CASE 
    ...
    ELSE convert_from(decrypt_iv(decode(encrypted_credential, 'base64'), (user_uuid::text || 'spotify_key')::bytea, '\x00000000000000000000000000000000', 'aes'), 'UTF8')
  END;
$$;
